...
const items = computed(() => {
  ...
  const raw = msgs.hokRoadmap?.items
...
const statusConfig: Record<string, { dotClass: string; label: string; labelColor: string }> = {
  ...
  plan: { dotClass: 'dot-plan', label: 'PLANNED', labelColor: '#9D4EDD' },
}
</script>

<template>
  <section id="hok-roadmap" class="py-24 px-6">
          ...
          <div class="flex flex-col items-center" style="width: 120px; flex-shrink: 0;">
            ...
            <div
              ...
              style="
                ...
                flex: 1;
                min-height: 40px;
                border-left: 1px dashed #9D4EDD40;
                margin-top: 6px;
              "
            />
          </div>
